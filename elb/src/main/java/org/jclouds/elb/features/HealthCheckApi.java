...
import org.jclouds.elb.xml.ConfigureHealthCheckResponseHandler;
...
public interface HealthCheckApi {
   ...
   @POST
   @Path("/")
   @XMLResponseParser(ConfigureHealthCheckResponseHandler.class)
   @FormParams(keys = ACTION, values = "ConfigureHealthCheck")
   Set<HealthCheck> configureHealthCheck(@FormParam("LoadBalancerName") String loadBalancerName,
